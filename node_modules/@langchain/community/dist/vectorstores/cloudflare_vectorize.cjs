 ...
 */
class CloudflareVectorizeStore extends vectorstores_1.VectorStore {
    _vectorstoreType() {
    ...
    async addVectors(vectors, documents, options) {
        ...
        const chunkSize = 500;
        const chunkedVectors = (0, chunk_array_1.chunkArray)(vectorizeVectors, chunkSize);
    ...
    async delete(params) {
        ...
        const batchedIds = (0, chunk_array_1.chunkArray)(params.ids, batchSize);
    ...
    async similaritySearchVectorWithScore(query, k) {
        ...
        if (results.matches) {
            for (const res of results.matches) {
                ...
                result.push([
                    new documents_1.Document({ metadata, pageContent: pageContent }),
                    res.score,
                ]);
            }
        }
