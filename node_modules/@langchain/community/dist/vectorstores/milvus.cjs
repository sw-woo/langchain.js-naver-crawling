 ...
 * class.
 */
class Milvus extends vectorstores_1.VectorStore {
    get lc_secrets() {
        return {
            ssl: "MILVUS_SSL",
    ...
    constructor(embeddings, args) {
        ...
        this.fields = [];
        const url = args.url ?? (0, env_1.getEnvironmentVariable)("MILVUS_URL");
    ...
    async delete(params) {
        ...
        if (deleteResp.status.error_code !== milvus2_sdk_node_1.ErrorCode.SUCCESS) {
