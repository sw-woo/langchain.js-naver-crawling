 ...
 * ```
 */
class ChatCloudflareWorkersAI extends chat_models_1.SimpleChatModel {
    static lc_name() {
    ...
    constructor(fields) {
        ...
        this.cloudflareAccountId =
            fields?.cloudflareAccountId ??
                (0, env_1.getEnvironmentVariable)("CLOUDFLARE_ACCOUNT_ID");
        this.cloudflareApiToken =
            fields?.cloudflareApiToken ??
                (0, env_1.getEnvironmentVariable)("CLOUDFLARE_API_TOKEN");
        this.baseUrl =
            fields?.baseUrl ??
        ...
        for await (const chunk of stream) {
            if (chunk !== "[DONE]") {
                ...
                const generationChunk = new outputs_1.ChatGenerationChunk({
                    message: new messages_1.AIMessageChunk({ content: parsedChunk.response }),
