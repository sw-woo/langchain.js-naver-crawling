...
export declare class MongoDBAtlasVectorSearch extends VectorStore {
     ...
     */
    static fromTexts(texts: string[], metadatas: object[] | object, embeddings: EmbeddingsInterface, dbConfig: MongoDBAtlasVectorSearchLibArgs): Promise<MongoDBAtlasVectorSearch>;
    /**
     * Static method to create an instance of MongoDBAtlasVectorSearch from a
     ...
     * @returns Promise that resolves to a new instance of MongoDBAtlasVectorSearch.
     */
    static fromDocuments(docs: Document[], embeddings: EmbeddingsInterface, dbConfig: MongoDBAtlasVectorSearchLibArgs): Promise<MongoDBAtlasVectorSearch>;
    /**
